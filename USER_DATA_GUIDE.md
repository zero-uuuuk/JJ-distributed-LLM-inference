# INFRASTRUCTURE AUTOMATION GUIDE (USER DATA)

> [!IMPORTANT]
> **vLLM 및 분산 추론 환경 자동 구성 가이드**

>
> Cloud 인스턴스 시작 시 `User Data` 섹션에 입력하여 vLLM 및 프로젝트 환경을 자동으로 구축하는 가이드입니다.
...
> **로그 확인 및 디버깅**
>
> 설정 과정에서 오류가 발생할 경우 `/var/log/user-data.log` 로그 파일을 확인하여 원인을 파악하고 디버깅할 수 있습니다.